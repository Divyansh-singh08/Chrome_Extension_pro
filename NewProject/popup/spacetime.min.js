!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(t)
    : ((e =
        "undefined" != typeof globalThis ? globalThis : e || self).spacetime =
        t());
})(this, function () {
  "use strict";
  const e = (e, t, n) => {
  ...
  var n = (e) => {
      ...
      if (void 0 === n.dst) return n.offset;
      let a = n.offset,
        r = n.offset + 1;
      "n" === n.hem && (r = a - 1);
      let o = n.dst.split("->");
    ...
    a = {
      ...
      "9|n":
        "2/chita,2/khandyga,2/pyongyang,2/seoul,2/tokyo,2/yakutsk,11/palau,japan,rok",
      "9.5|s|04/02:03->10/01:02":
      ...
      "4|s": "9/reunion",
      "4|n":
        "2/baku,2/dubai,2/muscat,2/tbilisi,2/yerevan,8/astrakhan,8/samara,8/saratov,8/ulyanovsk,8/volgograd,9/mahe,9/mauritius,2/volgograd",
      "4.5|n|03/22:00->09/21:24": "2/tehran,iran",
      "4.5|n": "2/kabul",
      "3|s": "12/syowa,9/antananarivo",
      "3|n|03/26:03->10/29:04":
        "2/famagusta,2/nicosia,8/athens,8/bucharest,8/helsinki,8/kyiv,8/mariehamn,8/riga,8/sofia,8/tallinn,8/uzhgorod,8/vilnius,8/zaporozhye,8/nicosia,8/kiev",
      ...
      "3|n":
        "0/addis_ababa,0/asmara,0/asmera,0/dar_es_salaam,0/djibouti,0/juba,0/kampala,0/mogadishu,0/nairobi,2/aden,2/amman,2/baghdad,2/bahrain,2/damascus,2/kuwait,2/qatar,2/riyadh,8/istanbul,8/kirov,8/minsk,8/moscow,8/simferopol,9/comoro,9/mayotte,2/istanbul,turkey,w-su",
      "2|s|03/26:02->10/29:02": "12/troll",
      "2|s":
        "0/gaborone,0/harare,0/johannesburg,0/lubumbashi,0/lusaka,0/maputo,0/maseru,0/mbabane",
      "2|n|03/26:02->10/29:03":
      ...
      "10|n":
        "2/ust-nera,2/vladivostok,11/guam,11/saipan,11/chuuk,11/truk,11/yap",
      "10.5|s|04/02:01->10/01:02": "4/lord_howe,4/lhi",
      "0|n|03/26:00->10/29:01": "1/scoresbysund,3/azores",
      "0|n":
        "0/abidjan,0/accra,0/bamako,0/banjul,0/bissau,0/conakry,0/dakar,0/freetown,0/lome,0/monrovia,0/nouakchott,0/ouagadougou,0/sao_tome,1/danmarkshavn,3/reykjavik,3/st_helena,13/gmt,13/utc,0/timbuktu,13/greenwich,13/uct,13/universal,13/zulu,gmt-0,gmt+0,gmt0,greenwich,iceland,uct,universal,utc,zulu,13/unknown",
      "-9|n|03/12:02->11/05:02": "1/adak,1/atka,us/aleutian",
      "-9|n": "11/gambier",
      "-9.5|n": "11/marquesas",
      "-8|n|03/12:02->11/05:02":
        "1/anchorage,1/juneau,1/metlakatla,1/nome,1/sitka,1/yakutat,us/alaska",
      "-8|n": "11/pitcairn",
      "-7|n|03/12:02->11/05:02":
        "1/los_angeles,1/santa_isabel,1/tijuana,1/vancouver,1/ensenada,6/pacific,10/bajanorte,us/pacific-new,us/pacific",
      "-7|n":
        "1/creston,1/dawson,1/dawson_creek,1/fort_nelson,1/hermosillo,1/phoenix,1/whitehorse,6/yukon,us/arizona",
      "-6|s|04/01:22->09/02:22": "11/easter,7/easterisland",
      "-6|n|03/12:02->11/05:02":
        "1/boise,1/cambridge_bay,1/denver,1/edmonton,1/inuvik,1/north_dakota,1/ojinaga,1/yellowknife,1/shiprock,6/mountain,navajo,us/mountain",
      "-6|n":
        "1/belize,1/chihuahua,1/costa_rica,1/el_salvador,1/guatemala,1/managua,1/mazatlan,1/regina,1/swift_current,1/tegucigalpa,11/galapagos,6/east-saskatchewan,6/saskatchewan,10/bajasur",
      "-5|s": "1/lima,1/rio_branco,1/porto_acre,5/acre",
      "-5|n|03/12:02->11/05:02":
      ...
      "-5|n":
        "1/bahia_banderas,1/bogota,1/cancun,1/cayman,1/coral_harbour,1/eirunepe,1/guayaquil,1/jamaica,1/merida,1/mexico_city,1/monterrey,1/panama,1/atikokan,jamaica,10/general",
      ...
      "-3|s":
        "1/argentina,1/buenos_aires,1/catamarca,1/cordoba,1/fortaleza,1/jujuy,1/mendoza,1/montevideo,1/punta_arenas,1/sao_paulo,12/palmer,12/rothera,3/stanley,1/argentina/la_rioja,1/argentina/rio_gallegos,1/argentina/salta,1/argentina/san_juan,1/argentina/san_luis,1/argentina/tucuman,1/argentina/ushuaia,1/argentina/comodrivadavia,1/argentina/buenos_aires,1/argentina/catamarca,1/argentina/cordoba,1/argentina/jujuy,1/argentina/mendoza,1/argentina/rosario,1/rosario,5/east",
      "-3|n|03/12:02->11/05:02":
  ...
  Object.keys(a).forEach((e) => {
    ...
    t[2] && (n.dst = t[2]),
      a[e].split(",").forEach((e) => {
        (e = e.replace(/(^[0-9]+)\//, (e, t) => ((t = Number(t)), r[t] + "/"))),
          (o[e] = n);
      });
  }),
    (o.utc = { offset: 0, hem: "n" });
  for (let e = -14; e <= 14; e += 0.5) {
    let t = e;
    t > 0 && (t = "+" + t);
    let n = "etc/gmt" + t;
    (o[n] = { offset: -1 * e, hem: "n" }),
      (n = "utc/gmt" + t),
      (o[n] = { offset: -1 * e, hem: "n" });
  }
  var i = o;
  ...
  var d = function (e) {
    ...
    if (((t = e.match(c)), null !== t)) return m(t[1]);
    if (((t = e.match(h)), null !== t)) {
      let e = -1 * Number(t[1]);
      return m(e);
    }
    return (t = e.match(l)), null !== t ? m(t[1]) : null;
  };
  const f = s(),
  ...
  var y = (e, t) => {
    ...
    if (
      ...
      return n;
    if (!0 === p.hasOwnProperty(n)) return p[n];
    if (!0 === /[0-9]/.test(n)) {
      let e = d(n);
      if (e) return e;
    }
  ...
  const D = { year: new Date().getFullYear(), month: 0, date: 1 };
  var M = {
    parseArray: (e, t, n) => {
  ...
  const S = function (e) {
    ...
    q = {
      ...
      yesterday: (e) =>
        (e = (e = (e = S(e)).subtract(1, "day")).startOf("day")),
      christmas: (e) => {
        let t = S(e).year();
  ...
  let T = { millisecond: 1, second: 1e3, minute: 6e4, hour: 36e5, day: 864e5 };
  (T.date = T.day),
    (T.month = 25488e5),
    (T.week = 6048e5),
    (T.year = 3154e7),
      ...
      month: {
        ...
        walkTo: (e, t) => {
          ...
          for (
            ...
            e.epoch += E.day;
          for (; e.d.getMonth() > t; ) e.epoch -= E.day;
        },
      },
      date: {
        valid: (e) => e > 0 && e <= 31,
  ...
  function B() {
    return (function () {
      const e = { sep: 8 };
      for (let t = 0; t < F.length; t++) e[F[t]] = t;
      for (let t = 0; t < P.length; t++) e[P[t]] = t;
      return e;
    })();
  }
  var H = (e, t) => {
  ...
  var Z = (e, t = "") => {
    ...
    if (null !== n) {
      ...
      e = (e = (e = (e = e.hour(a)).minute(r)).seconds(n[3] || 0)).millisecond(
        (function (e = "") {
          return (
            (e = String(e)).length > 3
              ? (e = e.substr(0, 3))
  ...
  let Q = B();
  const G = (e) => {
      if (!0 !== A.hasOwnProperty(e.month)) return !1;
      if (1 === e.month) return !!(g(e.year) && e.date <= 29) || e.date <= 28;
      let t = A[e.month] || 0;
      return e.date <= t;
    },
    U = (e = "", t) => {
    ...
    J = [
      ...
      },
      {
        ...
        parse: (e, t) => {
          ...
          return !1 === G(r) ? ((e.epoch = null), e) : (Y(e, r), (e = Z(e)));
        },
      },
      {
        reg: /^[0-9,]+ ?(a\.?d\.?|c\.?e\.?)$/i,
    ...
    K = [].concat(
        ...
        },
        {
          ...
          parse: (e, t) => {
            ...
            return (
              ...
              !1 === G(n) ? ((e.epoch = null), e) : (Y(e, n), (e = Z(e, t[4])))
            );
          },
        },
        {
      ...
      [
        ...
        },
        {
          ...
          parse: (e, t) => {
            let n = { year: U(t[3], e._today), month: V(t[2]), date: _(t[1]) };
            return n.month && !1 !== G(n)
              ? (Y(e, n), (e = Z(e, t[4])))
              : ((e.epoch = null), e);
          },
        },
        {
          ...
          parse: (e, t) => {
            let n = { date: Number(t[1]), month: V(t[2]), year: Number(t[3]) };
            return !1 === G(n)
              ? ((e.epoch = null), e)
              : (Y(e, n), (e = e.startOf("day")), (e = Z(e, t[4])));
          },
        },
      ],
      J
  ...
  var R = function (e, t, n) {
    ...
    return (
      !1 === e.silent &&
        console.warn("Warning: couldn't parse date-string: '" + t + "'"),
      (e.epoch = null),
      e
    );
  };
  const { parseArray: X, parseObject: ee, parseNumber: te } = M,
    ne = { year: new Date().getFullYear(), month: 0, date: 1 };
  var ae = (e, t) => {
    let n = e._today || ne;
    if ("number" == typeof t) return te(e, t);
    if (
      ((e.epoch = Date.now()),
    ...
    return null == t || "" === t
      ...
      : "string" != typeof t
      ? e
      : ((t = I(t)), !0 === N.hasOwnProperty(t) ? (e = N[t](e)) : R(e, t));
  };
  ...
  const he = (e) =>
    ...
    me = {
      ...
      iso: (e) =>
        `${e.format("iso-year")}-${w(e.month() + 1)}-${w(e.date())}T${w(
          e.h24()
        )}:${w(e.minute())}:${w(e.second())}.${w(e.millisecond(), 3)}${ce(e)}`,
      "iso-short": (e) => {
        let t = w(e.month() + 1),
          n = w(e.date());
        var a;
        return `${
          (a = e.year()) >= 0 ? w(a, 4) : "-" + w((a = Math.abs(a)), 4)
        }-${t}-${n}`;
      },
      "iso-utc": (e) => new Date(e.epoch).toISOString(),
      nice: (e) => `${L()[e.month()]} ${v(e.date())}, ${e.time()}`,
      "nice-24": (e) =>
        `${L()[e.month()]} ${v(e.date())}, ${e.hour24()}:${w(e.minute())}`,
      "nice-year": (e) => `${L()[e.month()]} ${v(e.date())}, ${e.year()}`,
      "nice-day": (e) =>
        `${ie()[e.day()]} ${he(L()[e.month()])} ${v(e.date())}`,
      "nice-full": (e) =>
        `${e.dayName()} ${he(e.monthName())} ${v(e.date())}, ${e.time()}`,
      "nice-full-24": (e) =>
        `${e.dayName()} ${he(e.monthName())} ${v(e.date())}, ${e.hour24()}:${w(
          e.minute()
        )}`,
    },
    de = {
  ...
  Object.keys(de).forEach((e) => (me[e] = me[de[e]]));
  var fe = (e, t = "") => {
    ...
    if (me.hasOwnProperty(t)) {
      ...
      return (
        "json" !== t &&
          ((n = String(n)), "ampm" !== t.toLowerCase() && (n = he(n))),
        n
      );
    }
    if (-1 !== t.indexOf("{")) {
      ...
      return (
        (t = t.replace(n, (t, n) => {
          if (((n = n.toLowerCase().trim()), me.hasOwnProperty(n))) {
            let t = String(me[n](e));
  ...
  const pe = {
    ...
    ye = (e, t, n) => {
      let a = e,
        r = t;
      for (let o = 0; o < n; o += 1) (pe[a] = pe[r]), (a += e), (r += t);
    };
  ye("q", "Q", 4),
    ye("L", "M", 4),
    ye("Y", "y", 4),
  ...
  var ve = (e, t) => {
    let n = e.progress();
    return (
      "quarterhour" === (t = j(t)) && (t = "quarterHour"),
      void 0 !== n[t]
      ...
      Object.keys(e).forEach((o, i, s) => {
        ...
        if ((r.push(l), !t)) {
          ...
          const a = s[i + 1],
            r = Math.abs(e[a]);
          r > Me[a].almost
            ? ((t = Se(u + 1, o)), (n = "almost " + t))
            : r > Me[a].over && (n = "over " + l);
        }
      }),
  ...
  var Ne = (e, t) => {
    ...
    let a,
      r = "future",
      { rounded: o, qualified: i, englishValues: s, abbreviated: u } = qe(n);
    (a = s.splice(0, 2).join(", ")),
      !0 === e.isAfter(t)
        ? ((o += " ago"), (i += " ago"), (a += " ago"), (r = "past"))
        : ((o = "in " + o), (i = "in " + i), (a = "in " + a));
    let l = De(n);
    return {
      diff: n,
      rounded: o,
  ...
  const Ee = {
    second: (e) => (Y(e, { millisecond: 0 }), e),
    minute: (e) => (Y(e, { second: 0, millisecond: 0 }), e),
    quarterhour: (e) => {
      let t = e.minutes();
      return (
        (e =
          t >= 45
            ...
            ? e.minutes(15)
            : e.minutes(0)),
        Y(e, { second: 0, millisecond: 0 }),
        e
      );
    },
    hour: (e) => (Y(e, { minute: 0, second: 0, millisecond: 0 }), e),
    day: (e) => (Y(e, { hour: 0, minute: 0, second: 0, millisecond: 0 }), e),
    week: (e) => {
      let t = e.clone();
      return (
        (e = e.day(e._weekStart)).isAfter(t) && (e = e.subtract(1, "week")),
        Y(e, { hour: 0, minute: 0, second: 0, millisecond: 0 }),
        e
      );
    },
    month: (e) => (
      Y(e, { date: 1, hour: 0, minute: 0, second: 0, millisecond: 0 }), e
    ),
    quarter: (e) => {
      let t = e.quarter();
      return (
  ...
  var Ce = function (e, t, n) {
    if (!t || !n) return [];
    if (((t = j(t)), (n = e.clone().set(n)), e.isAfter(n))) {
      let t = e;
      (e = n), (n = t);
    }
    let a = e.clone();
  ...
  var xe = (e) => {
    let n = e.timezones,
      a = e.tz;
    if ((!1 === n.hasOwnProperty(a) && (a = y(e.tz, n)), null === a))
      return (
        !1 === e.silent &&
          console.warn(
    ...
    let r = n[a],
      o = {
        name:
          ((i = a),
          (i = (i = (i = (i = (i = (i = (i =
            i[0].toUpperCase() + i.substr(1)).replace(/[\/_-]([a-z])/gi, (e) =>
            e.toUpperCase()
          )).replace(/_(of|es)_/i, (e) => e.toLowerCase())).replace(
            /\/gmt/i,
            "/GMT"
          )).replace(/\/Dumontdurville$/i, "/DumontDUrville")).replace(
            /\/Mcmurdo$/i,
            "/McMurdo"
          )).replace(/\/Port-au-prince$/i, "/Port-au-Prince"))),
    ...
    if (o.hasDst) {
      ...
      o.change = { start: e[0], back: e[1] };
    }
    let u = r.offset,
      l = u;
    return (
      !0 === o.hasDst && (l = "North" === o.hemisphere ? u - 1 : r.offset + 1),
      !1 === o.hasDst
        ? ((o.current.offset = u), (o.current.isDST = !1))
        : !0 === t(e.epoch, o.change.start, o.change.back, u, l)
        ? ((o.current.offset = u), (o.current.isDST = "North" === o.hemisphere))
        : ((o.current.offset = l),
  ...
  const Ye = [
    ...
    Ae = {
      set: function (e, t) {
        let n = this.clone();
        return (n = ae(n, e)), t && (this.tz = y(t)), n;
      },
      timezone: function () {
        return xe(this);
      },
      ...
      since: function (e) {
        return e || (e = this.clone().set()), Ne(this, e);
      },
      next: function (e) {
      ...
      log: function () {
        return console.log(""), console.log(fe(this, "nice-short")), this;
      },
      logYear: function () {
        return console.log(""), console.log(fe(this, "full-short")), this;
      },
      json: function () {
        return Ye.reduce((e, t) => ((e[t] = this[t]()), e), {});
      },
      debug: function () {
        let e = this.timezone(),
          t =
  ...
  var Fe = Ae;
  const Pe = (e) => ("string" == typeof e && (e = parseInt(e, 10)), e),
    ...
    Ze = function (e, t, n) {
      ...
      return (
        (e.epoch -= r), Be(e, a, "second"), (e = He(e, a, n, "hour")).epoch
      );
    },
    Qe = function (e, t, n) {
  ...
  const We = {
      ...
      if (void 0 !== e) {
        ...
        return (
          (n.epoch = (function (e, t, n) {
            ...
            return (e.epoch = e.epoch - r), (e = He(e, a, n, "minute")).epoch;
          })(n, e, t)),
          n
        );
      }
    ...
    hourFloat: function (e, t) {
      if (void 0 !== e) {
        ...
        a *= 60;
        let r = parseInt(e, 10);
        return (n.epoch = Qe(n, r, t)), (n.epoch = Ze(n, a, t)), n;
      }
      let n = this.d,
        a = n.getHours(),
        r = n.getMinutes();
      ...
      if (void 0 !== e) {
        ...
        return (
          ...
          (n.epoch = (function (e, t, n) {
            ...
            if (!a) {
              if (((a = t.match(/([0-9]{1,2}) ?(am|pm)/)), !a)) return e.epoch;
            ...
            let s = parseInt(a[3], 10) || 0,
              u = e.clone();
            return (
              (e = (e = (e = (e = e.hour(o)).minute(i)).second(s)).millisecond(
                0
              )),
    ...
    ampm: function (e, t) {
      let n = Ue,
        a = this.hour();
      if ((a >= 12 && (n = Ve), "string" != typeof e)) return n;
      let r = this.clone();
      return (
        (e = e.toLowerCase().trim()),
        a >= 12 && "am" === e
  ...
  const Ke = {
        ...
        return (
          (e = parseInt(e, 10)) &&
            (n.epoch = (function (e, t, n) {
              ...
              t <= 0 && (t = 1);
              let a = e.clone();
              return Y(e, { date: t }), (e = He(e, a, n, "month")).epoch;
            })(n, e, t)),
          n
        );
      }
    ...
    day: function (e, t) {
      ...
      "string" == typeof e &&
        ...
        ue.hasOwnProperty(e)
          ? (a = ue[e])
          : ((a = ie().indexOf(e)), -1 === a && (a = se().indexOf(e))));
      let r = this.d.getDay() - a;
      !0 === t && r > 0 && (r -= 7), !1 === t && r < 0 && (r += 7);
      let o = this.subtract(r, "days");
      return (
        Y(o, { hour: n.hour(), minute: n.minute(), second: n.second() }), o
      );
    },
    dayName: function (e, t) {
      if (void 0 === e) return se()[this.day()];
      let n = this.clone();
  ...
  const Xe = (e) => (e = (e = (e = e.minute(0)).second(0)).millisecond(1)),
    et = {
      ...
      week: function (e, t) {
        ...
        let o = 0,
          i = 4 * this.month();
        for (n.epoch += E.week * i, o += i; o <= 52; o++) {
      ...
      month: function (e, t) {
        if (void 0 !== e) {
          ...
          return (
            (n.epoch = (function (e, t, n) {
              "string" == typeof t &&
                ("sept" === t && (t = "sep"), (t = B()[t.toLowerCase()])),
                (t = Pe(t)) >= 12 && (t = 11),
                t <= 0 && (t = 0);
              let a = e.date();
              a > A[t] && (a = A[t]);
              let r = e.clone();
              return Y(e, { month: t, d: a }), (e = He(e, r, n, "year")).epoch;
            })(n, e, t)),
            n
          );
        }
      ...
      quarter: function (e, t) {
        ...
        for (let e = 1; e < Te.length; e++) if (n < Te[e][0]) return e - 1;
        return 4;
      },
      season: function (e, t) {
        let n = "north";
        ...
        for (let e = 0; e < Ie[n].length - 1; e++)
          if (a >= Ie[n][e][1] && a < Ie[n][e + 1][1]) return Ie[n][e][0];
  ...
  const rt = function (e, t) {
    ...
    it = (e, t, n) => {
      let a = t.year(),
        ...
        o = rt(r, a);
      for (; n > o; )
        (n -= o), (r += 1), r >= 12 && ((r -= 12), (a += 1)), (o = rt(r, a));
  ...
  (lt.week = lt.hour), (lt.season = lt.date), (lt.quarter = lt.date);
  const ct = {
      year: !0,
      quarter: !0,
      season: !0,
    ...
    ht = { month: !0, quarter: !0, season: !0, year: !0 };
  var mt = (e) => {
    (e.prototype.add = function (e, t) {
      let n = this.clone();
      if (!t || 0 === e) return n;
      let a = this.clone();
      if ("millisecond" === (t = j(t))) return (n.epoch += e), n;
      "fortnight" === t && ((e *= 2), (t = "week")),
        E[t]
          ...
          : "quarter" === t || "season" === t
          ? (n.epoch += E.month * (3 * e))
          : "quarterhour" === t && (n.epoch += 15 * E.minute * e);
      let r = {};
      if (
        (lt[t] &&
          lt[t].forEach((e) => {
      ...
      if (
        ("month" === t && ((r.month = a.month() + e), (r = ot(r, a))),
        "week" === t)
      ) {
        let t = a.date() + 7 * e;
        t <= 28 && t > 1 && (r.date = t);
      ...
      if ("weekend" === t && "saturday" !== n.dayName())
        ...
        if (((r.month = a.month() + 3 * e), (r.year = a.year()), r.month < 0)) {
      ...
      return Object.keys(r).length > 1 && Y(n, r), n;
    }),
  ...
  var yt = (e) => {
    const t = {
      i18n: (e) => {
        var t, n, a;
        k(e.days) && ((t = e.days), (re = t.short || re), (oe = t.long || oe)),
          k(e.months) &&
            (function (e) {
              (F = e.short || F), (P = e.long || P);
            })(e.months),
          (a = e.useTitleCase),
          "[object Boolean]" === Object.prototype.toString.call(a) &&
            ((n = e.useTitleCase), (le = n)),
          k(e.ampm) &&
            (function (e) {
              (Ue = e.am || Ue), (Ve = e.pm || Ve);
            })(e.ampm);
      },
    };
    Object.keys(t).forEach((n) => {
  ...
  return (
    ...
    (vt.today = (e, t) => {
      let n = new kt(new Date().getTime(), e, t);
      return (n = _t(n)), n.startOf("day");
    }),
    (vt.tomorrow = (e, t) => {
      let n = new kt(new Date().getTime(), e, t);
      return (n = _t(n)), n.add(1, "day").startOf("day");
    }),
    (vt.yesterday = (e, t) => {
      let n = new kt(new Date().getTime(), e, t);
      return (n = _t(n)), n.subtract(1, "day").startOf("day");
    }),
