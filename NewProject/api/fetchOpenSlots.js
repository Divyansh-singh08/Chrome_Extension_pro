...
//API call going to request gov website for list of appointment
//here we go to filter the which one is open now for the user to select
//for the earliest days who match the criteria
